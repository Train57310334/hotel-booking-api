...
async function main() {
  ...
  // Optional: Clean DB or just add to it. Let's add ensuring uniqueness via name check or just create new.
  // Ideally, truncate tables but preserving user demo if needed.
  ...
  for (const h of hotelsData) {
    ...
    }).catch(() => {}); // Catch if user doesn't exist, though standard seed creates it.
